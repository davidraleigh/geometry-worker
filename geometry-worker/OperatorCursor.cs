        ...
        public GeometryCursor GenerateCursor(ref double distance, ref bool spatialRelationship, ref List<Proximity2DResult> proximityResults) {
            ...
            switch (m_operatorType) {
                ...
                case Operator.Type.Cut:
                    geometryCursor = OperatorCut.Local().Execute(input_booleans[0], m_leftGeometrCurosr.Next(), (Polyline)m_rightGeometryCursor.Next(), m_spatialReference, null);
                    break;
                ...
                case Operator.Type.DensifyByLength:
                    OperatorDensifyByLength.Local().Execute(m_leftGeometrCurosr, input_doubles[0], null);
                    break;
                case Operator.Type.Difference:
                    OperatorDifference.Local().Execute(m_leftGeometrCurosr, m_rightGeometryCursor, m_spatialReference, null);
                    break;
                ...
                case Operator.Type.Generalize:
                    geometryCursor = OperatorGeneralize.Local().Execute(m_leftGeometrCurosr, input_doubles[0], input_booleans[0], null);
                    break;
                ...
                case Operator.Type.Proximity2D:
                    ...
                    else if (input_doubles.Length == 1 && input_integers.Length == 1)
                ...
                case Operator.Type.Simplify:
                    geometryCursor = OperatorSimplify.Local().Execute(m_leftGeometrCurosr, m_spatialReference, input_booleans[0], null);
                    break;
                case Operator.Type.SimplifyOGC:
                    geometryCursor = OperatorSimplifyOGC.Local().Execute(m_leftGeometrCurosr, m_spatialReference, input_booleans[0], null);
                    break;
